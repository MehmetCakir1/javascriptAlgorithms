// Oh no!
// The new zookeeper has lost track of how many animals are in the zoo 
// because the last person to do the count thought it would be funny to do it in binary.
...
function countTheAnimals(animals) {
    ...
    arr.map((item)=>sum+=(parseInt(item,2)))
    return sum
    }
